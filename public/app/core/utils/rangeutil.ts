...
const rangeOptions = [
  { from: 'now/d', to: 'now/d', display: '今日', section: 2 },
  { from: 'now/d', to: 'now', display: '今日（〜現在）', section: 2 },
  { from: 'now/w', to: 'now/w', display: '今週', section: 2 },
  { from: 'now/w', to: 'now', display: '今週（〜現在）', section: 2 },
  { from: 'now/M', to: 'now/M', display: '今月', section: 2 },
  { from: 'now/M', to: 'now', display: '今月（〜現在）', section: 2 },
  { from: 'now/y', to: 'now/y', display: '今年', section: 2 },
  { from: 'now/y', to: 'now', display: '今年（〜現在）', section: 2 },
  ...
  { from: 'now-1w/w', to: 'now-1w/w', display: '先週', section: 1 },
  { from: 'now-1M/M', to: 'now-1M/M', display: '先月', section: 1 },
  { from: 'now-1y/y', to: 'now-1y/y', display: '昨年', section: 1 },
  ...
  { from: 'now-2d', to: 'now', display: '直近 2 日', section: 0 },
  { from: 'now-7d', to: 'now', display: '直近 7 日', section: 0 },
  { from: 'now-30d', to: 'now', display: '直近 30 日', section: 0 },
  { from: 'now-90d', to: 'now', display: '直近 90 日', section: 0 },
  { from: 'now-6M', to: 'now', display: '直近 6 ヶ月', section: 0 },
  { from: 'now-1y', to: 'now', display: '直近 1 年', section: 0 },
  { from: 'now-2y', to: 'now', display: '直近 2 年', section: 0 },
  { from: 'now-5y', to: 'now', display: '直近 5 年', section: 0 },
];
